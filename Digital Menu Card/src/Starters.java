...
public class Starters implements ActionListener
{
	...
	public void edit()
	{
		frame1 = new JFrame("Edit Starters");
	...
	public void insert()
	{
		...
		try
		{
            ...
            PreparedStatement ps = con.prepareStatement("insert into starters values(?,?,?)");
            ps.setString(1, item);
            ps.setInt(2, price);
            ps.setString(3, id);
            ps.executeUpdate();
	...
	public void delete()
	{
		...
		try
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotelmenu", "root", "root");
            PreparedStatement ps = con.prepareStatement("delete from starters where id=?");
            ps.setString(1, id);
            ps.executeUpdate();
		}
		catch(Exception e)
