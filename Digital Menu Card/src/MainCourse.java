...
public class MainCourse implements ActionListener
{
	...
	public void edit()
	{
		frame1 = new JFrame("Edit Main Course");
	...
	public void insert()
	{
		...
		try
		{
            ...
            PreparedStatement ps = con.prepareStatement("insert into maincourse values(?,?,?)");
            ps.setString(1, item);
            ps.setInt(2, price);
            ps.setString(3, id);
            ps.executeUpdate();
	...
	public void delete()
	{
		...
		try
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotelmenu", "root", "root");
            PreparedStatement ps = con.prepareStatement("delete from maincourse where id=?");
            ps.setString(1, id);
            ps.executeUpdate();
		}
		catch(Exception e)
